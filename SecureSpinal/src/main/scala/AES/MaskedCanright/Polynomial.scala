...
/* Inversion of polynomials in GF(2^8) using the Tower Field Approach
*  for masked and unmasked polynomials
* */

/* Inversion of a masked polynomial in GF(2^8)
*  Inputs:	A:		1st share of the input
*  					M: 		2nd share of the input (= input mask)
* 					S: 		Output mask (=2nd share of the output)
*  Outputs: AInv: 1st share of output
* */
...
class G256InvMaskedOptimized extends Component {
	...
	/* Helper function to instantiate all G16Mul multipliers and connect inputs
	* and outputs */
...
/* Unoptimized masked inversion in GF(2^8) */
...
/* Unoptimized inversion in GF(2^4) */
