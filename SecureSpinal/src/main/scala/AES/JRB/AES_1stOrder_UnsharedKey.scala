...
case class AES_1stOrder_UnsharedKey() extends Component {
	val io = new Bundle {
		val clk = in  Bool()
		val reset = in  Bool()
...
object AES_1stOrder_UnsharedKey extends App {
	SpinalConfig(mode = VHDL, targetDirectory = "C:/Users/fabusbo/Desktop/VE-HEP/ap3/SpinalHDL/SecureSpinal/src/main/scala/AES/JRB/RTL").generate(AES_1stOrder_UnsharedKey())
}